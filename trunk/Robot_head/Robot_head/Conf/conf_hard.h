...
#define		CONF_EVENT_CAM_PICT_RCV		8U
...
#define E_PROTOCOLE_CMD_LEFT_RIGHT_EYE_ON	3U
#define E_PROTOCOLE_CMD_LEFT_RIGHT_EYE_OFF	4U
#define E_PROTOCOLE_CMD_LEFT_RIGHT_EYE_TOGGLE	5U
